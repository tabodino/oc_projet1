...
<section id="top-section" class="ak-container">
	...
	<div id="featured-post-1" class="featured-post">
		...
		<img src="http://villedellupia.esy.es/wp-content/themes/accesspress-lite.2.46.6/accesspress-lite/images/actualite.jpg" alt="actualites">
		</a>
		</figure>
		...
		<div class="featured-content">
			...
			<a href="actualites" class="read-more bttn">En savoir plus</a>
		</div>
	</div>
	...
	<div id="featured-post-2" class="featured-post">
		...
		<img src="http://villedellupia.esy.es/wp-content/themes/accesspress-lite.2.46.6/accesspress-lite/images/info.jpg" alt="information">
		</a>
		</figure>

		<h2><a href="plus-dinfos">Plus d'infos</a></h2>
		...
		<div class="featured-content">
			...
			<a href="plus-dinfos" class="read-more bttn">En savoir plus</a>
		</div>
	</div>
	...
	<div id="featured-post-3" class="featured-post">
		...
		<figure class="featured-image">
		<a href="activites-du-mois">
		<div class="featured-overlay">
			<span class="overlay-plus font-icon-plus"></span>
		</div>

		<img src="http://villedellupia.esy.es/wp-content/themes/accesspress-lite.2.46.6/accesspress-lite/images/activites.jpg" alt="activites du mois">
		</a>
		</figure>

		<h2><a href="activites-du-mois">Activités du mois</a></h2>

		<div class="featured-content">
			<p>Envie d'évasion ou de pratiques sportives ? Les activités proposées par la ville n'attendent plus que vous.</p>
			<a href="activites-du-mois" class="read-more bttn">En savoir plus</a>
		</div>
	</div>
